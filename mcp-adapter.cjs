...
const _allModules = [
        ...
        { id: 'excel', name: 'Excel Workbook Operations', capabilities: ['excelSession', 'excelWorksheet', 'excelRange', 'excelTable', 'excelFunction'] },
...
const stubModuleRegistry = {
    ...
    getModule: (moduleName) => {
        const modules = {
            ...
            'excel': { id: 'excel', capabilities: ['excelSession', 'excelWorksheet', 'excelRange', 'excelTable', 'excelFunction'] },
            'word': { id: 'word', capabilities: ['wordDocument'] },
...
async function executeModuleMethod(moduleName, methodName, params = {}) {
    try {
        ...
        switch (moduleMethod) {
            ...
            // ========== Consolidated Excel compound tools (MCP-facing) ==========
            case 'excel.excelSession':
                apiPath = '/v1/excel/session/action';
                apiMethod = 'POST';
                apiData = params;
                break;
            case 'excel.excelWorksheet':
                apiPath = '/v1/excel/worksheet/action';
                apiMethod = 'POST';
                apiData = params;
                break;
            case 'excel.excelRange':
                apiPath = '/v1/excel/range/action';
                apiMethod = 'POST';
                apiData = params;
                break;
            case 'excel.excelTable':
                apiPath = '/v1/excel/table/action';
                apiMethod = 'POST';
                apiData = params;
                break;
            case 'excel.excelFunction':
                apiPath = '/v1/excel/function/action';
                apiMethod = 'POST';
                apiData = params;
                break;

            // ========== Consolidated Word compound tool (MCP-facing) ==========
            case 'word.wordDocument':
                apiPath = '/v1/word/action';
                apiMethod = 'POST';
                apiData = params;
                break;

            // ========== Consolidated PowerPoint compound tool (MCP-facing) ==========
            case 'powerpoint.powerpointPresentation':
                apiPath = '/v1/powerpoint/action';
                apiMethod = 'POST';
                apiData = params;
                break;
